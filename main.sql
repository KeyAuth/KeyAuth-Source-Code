...
--
-- Host: localhost
-- Generation Time: Aug 04, 2022 at 03:20 AM
...
CREATE TABLE `accounts` (
  ...
  `regionName` varchar(99) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `emailverify` (
  ...
  `time` int(1) NOT NULL,
  `regionName` varchar(99) DEFAULT NULL,
...
--
ALTER TABLE `users`
  ADD KEY `main index` (`username`,`app`);
