...
if (isset($_POST['updatesettings'])) {
    ...
    $customDomainAPI = misc\etc\sanitize($_POST['customDomainAPI']);
    ...
    if (!is_null($customDomainAPI) && $_SESSION['role'] != "tester") {
        ...
        $data = '{"Hostname":"' . $customDomainAPI . '"}';

        curl_setopt($curl, CURLOPT_POSTFIELDS, $data);

        curl_exec($curl);
        misc\cache\purge('KeyAuthApp:' . $customDomainAPI);
    } else if (!empty($customDomainAPI)) {
        dashboard\primary\error("You must have developer plan or higher.");
        echo "<meta http-equiv='Refresh' Content='2;'>";
        return;
    }
    ...
    mysqli_query($link, "UPDATE `apps` SET 
		...
		`sessionUnit` = '$sessionexpiry',
		`appdisabled` = '$appdisabledpost',
		`hashcheckfail` = '$hashcheckfailpost',
		`sessionunauthed` = '$sessionunauthedpost',
		`userbanned` = '$userbannedpost',
		`vpnblocked` = '$vpnblockedpost',
		`keybanned` = '$keybannedpost',
		`usernametaken` = '$usernametakenpost',
		`keynotfound` = '$keynotfoundpost',
		`keyused` = '$keyusedpost',
		`nosublevel` = '$nosublevelpost',
		`usernamenotfound` = '$usernamenotfoundpost',
		`passmismatch` = '$passmismatchpost',
		`hwidmismatch` = '$hwidmismatchpost',
		`noactivesubs` = '$noactivesubspost',
		`hwidblacked` = '$hwidblackedpost',
		`pausedsub` = '$pausedsubpost',
		`enabled` = '$status',
		`minUsernameLength` = '$minUsernameLength',
		`blockLeakedPasswords` = '$blockLeakedPasswords',
		`hashcheck` = '$hashstatus',
		`hwidcheck` = '$hwid',
		`vpnblock` = '$vpn',
		`ver` = '$ver',
		`download` = NULLIF('$dl', ''),
		`webdownload` = NULLIF('$webdl', ''),
		`webhook` = NULLIF('$webhooker', ''),
		`resellerstore` = NULLIF('$resellerstorelink', ''),
		`sellixsecret` = NULLIF('$sellixwebhooksecret', ''),
		`sellixdayproduct` = NULLIF('$sellixday', ''),
    ...
    if ($_SESSION['app']) {
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_array($result)) {
                ...
                $customDomainAPI = $row['customDomainAPI'];
            ...
            <form class="form" method="post">
                ...
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label">Status <i
                            ...
                            data-bs-placement="top" title="Allow people to open application or not"></i></label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="customDomainAPI" value="<?php echo $customDomainAPI; ?>"
                            placeholder="api.example.com" type="text">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="10" name="version" value="<?php echo $verr; ?>"
                            placeholder="<?php echo $verr; ?>" placeholder="Application Verion..">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="download" value="<?php echo $dll; ?>" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="webdownload" value="<?php echo $webdll; ?>" type="text"
                            placeholder="URL link for web loader (this will enable web loader if not empty)">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="webhook" value="<?php echo $wh; ?>" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="resellerstore" value="<?php echo $rs; ?>"
                ...
                <br>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-2 col-form-label">Customer panel custom domain <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top"
                ...
                <br>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-2 col-form-label">HWID Reset Cooldown Unit: <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top"
                    ...
                    <div class="col-10">
                        <select name="cooldownexpiry" class="form-control">
                            ...
                            <option value="1" <?= $cooldownUnit == 1 ? ' selected="selected"' : ''; ?>>Seconds</option>
                            <option value="604800" <?= $cooldownUnit == 604800 ? ' selected="selected"' : ''; ?>>Weeks
                            </option>
                            <option value="2629743" <?= $cooldownUnit == 2629743 ? ' selected="selected"' : ''; ?>>
                                Months</option>
                            <option value="31556926" <?= $cooldownUnit == 31556926 ? ' selected="selected"' : ''; ?>>
                                Years</option>
                            <option value="315569260" <?= $cooldownUnit == 315569260 ? ' selected="selected"' : ''; ?>>
                                Lifetime</option>
                        </select>
                    </div>
                </div>
                ...
                <br>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-2 col-form-label">Session Expiry Unit: <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top"
                    ...
                    <div class="col-10">
                        <select name="sessionexpiry" class="form-control">
                            ...
                            <option value="60" <?= $sessionUnit == 60 ? ' selected="selected"' : ''; ?>>Minutes</option>
                ...
                <br>
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label">Kill other user sessions <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top"
                            title="If user has other sessions, kill them when user logs in."></i></label>
                    <div class="col-10">
                        <select class="form-control" name="killOtherSessions">
                            <option value="0" <?= $killOtherSessions == 0 ? ' selected="selected"' : ''; ?>>Disabled
                            </option>
                            <option value="1" <?= $killOtherSessions == 1 ? ' selected="selected"' : ''; ?>>Enabled
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <br>
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label">Block leaked passwords <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top"
                    ...
                    <div class="col-10">
                        <select class="form-control" name="blockLeakedPasswords">
                            <option value="0" <?= $blockLeakedPasswords == 0 ? ' selected="selected"' : ''; ?>>Disabled
                            </option>
                            <option value="1" <?= $blockLeakedPasswords == 1 ? ' selected="selected"' : ''; ?>>Enabled
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="appdisabled" id="defaultconfig-3"
                            value="<?php echo $appdisabled; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="hashcheckfail" id="defaultconfig-3"
                            value="<?php echo $hashcheckfail; ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="vpnblocked" id="defaultconfig-3"
                            value="<?php echo $vpnblocked; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="usernametaken" id="defaultconfig-3"
                            value="<?php echo $usernametaken; ?>"
                            placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="keynotfound" id="defaultconfig-3"
                            value="<?php echo $keynotfound; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="keyused" id="defaultconfig-3"
                            value="<?php echo $keyused; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="keybanned" id="defaultconfig-3"
                            value="<?php echo $keybanned; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="nosublevel" id="defaultconfig-3"
                            value="<?php echo $nosublevel; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="userbanned" id="defaultconfig-3"
                            value="<?php echo $userbanned; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="usernamenotfound" id="defaultconfig-3"
                            value="<?php echo $usernamenotfound; ?>"
                            placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="passmismatch" id="defaultconfig-3"
                            value="<?php echo $passmismatch; ?>"
                            placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="hwidmismatch" id="defaultconfig-3"
                            value="<?php echo $hwidmismatch; ?>"
                            placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="noactivesubs" id="defaultconfig-3"
                            value="<?php echo $noactivesubs; ?>"
                            placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="hwidblacked" id="defaultconfig-3"
                            value="<?php echo $hwidblacked; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="100" name="pausedsub" id="defaultconfig-3"
                            value="<?php echo $pausedsub; ?>" placeholder="Custom response you'd like. Max 100 chars">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <br>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-2 col-form-label">Reseller Webhook Link <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top"
                ...
                <br>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-2 col-form-label">Shoppy Webhook Secret <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Shoppy webhook secret for reseller system"></i></label>
                    <div class="col-10">
                        <input class="form-control secret" maxlength="16" name="shoppywebhooksecret"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" maxlength="7" name="shoppylifetimeproduct"
                            value="<?php echo $shoppylifetimeproduct; ?>" id="defaultconfig-3"
                            placeholder="Product ID of Lifetime Reseller Key Shoppy Product">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-2 col-form-label">Sellix Webhook Secret <i
                            class="fas fa-question-circle fa-lg text-white-50" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Sellix webhook secret for reseller system"></i></label>
                    <div class="col-10">
                        <input class="form-control secret" maxlength="32" name="sellixwebhooksecret"
