                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <a type="button" class="btn btn-info" target="popup"
                            onclick="window.open('https://discord.com/api/oauth2/authorize?client_id=1091046318237040751&redirect_uri=https%3A%2F%2F<?php echo ($_SERVER['HTTP_HOST'] ?? $_SERVER['SERVER_NAME']); ?>%2Fapi%2Fdiscord%2F&response_type=code&scope=identify%20guilds.join','popup','width=600,height=600'); return false;">
