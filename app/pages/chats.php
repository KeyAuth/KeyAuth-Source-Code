...
<div id="edit-user" class="modal show" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    style="display: block;" aria-modal="true" o ydo>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header d-flex align-items-center">
                ...
                <button type="button" onClick="window.location.href=window.location.href" class="close ml-auto"
            ...
            <div class="modal-body">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <label for="recipient-name" class="control-label">Chat cooldown: <i
                                class="fas fa-question-circle fa-lg text-white-50" data-toggle="tooltip"
                                data-placement="top"
                                title="Delay users will have to wait to send their next message"></i></label>

                        <input name="delay" type="number" class="form-control"
                            placeholder="Multiplied by selected delay unit" required>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-danger waves-effect waves-light" value="<?php echo $chan; ?>"
                    name="savechan">Save</button>
...
<script src="https://cdn.keyauth.cc/dashboard/unixtolocal.js"></script>
    <form method="POST">
        ...
        <button data-bs-toggle="modal" type="button" data-bs-target="#clear-channel"
            class="dt-button buttons-print btn btn-primary mr-1"><i
                class="fas fa-cloud-upload-alt fa-sm text-white-50"></i> Clear channel</button>
        <button data-bs-toggle="modal" type="button" data-bs-target="#unmute-user"
            class="dt-button buttons-print btn btn-primary mr-1"><i class="fas fa-undo fa-sm text-white-50"></i> Unmute
            User</button>
    </form>


    <div id="create-channel" class="modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
    ...
    <div id="unmute-user" class="modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
    ...
    <div id="clear-channel" class="modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
    ...
    ?>
    <div id="mute-user" class="modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="time"
                                placeholder="Multiplied by selected unit of time muted">
    ...
    <table id="kt_datatable_chats" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
        ...
        <tbody>
            ...
            <tr>
                ...
                <form method="POST">
                    <td><a class="btn btn-sm btn-light btn-active-light-primary btn-sm" data-toggle="dropdown"
                        ...
                        <div
                            ...
                            <div class="menu-item px-3">
                                <button class="btn menu-link px-3" style="font-size:0.95rem;" name="deletechan"
                                    value="<?php echo $chan; ?>">Delete</button>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <button class="btn menu-link px-3" style="font-size:0.95rem;" name="editchan"
                                    value="<?php echo $chan; ?>">Edit</button>
                            </div>
                            <!--end::Menu item-->
                        </div>
                    </td>
                ...
                <form method="POST">
                    <td><a class="btn btn-sm btn-light btn-active-light-primary btn-sm" data-toggle="dropdown"
                        ...
                        <div
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <button class="btn menu-link px-3" style="font-size:0.95rem;" name="deletemsg"
                                    value="<?php echo $row["id"]; ?>">Delete</button>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#mute-user"
                                    onclick="muteuser('<?php echo $user; ?>')">Mute</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                    </td>
