                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <script>
                                                    document.write(convertTimestamp(<?php echo $row["gendate"]; ?>));
                                                </script>
                                            </td>
                                            ...
                                            <td>
                                                <script>
                                                    document.write(convertTimestamp(<?php echo $row["usedon"]; ?>));
                                                </script>
                                            </td>
                                            ...
                                            <form method="POST">
                                                <td><button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <button class="dropdown-item" name="editkey" value="<?php echo $key; ?>">Edit</button>
                                                    </div>
                                                </td>
                                        </tr>
                                        </form>
