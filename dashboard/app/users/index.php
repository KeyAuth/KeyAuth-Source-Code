                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <script>
                                                    document.write(convertTimestamp(<?php echo $row["createdate"]; ?>));
                                                </script>
                                            </td>
                                            ...
                                            <td>
                                                <script>
                                                    document.write(convertTimestamp(<?php echo $row["lastlogin"]; ?>));
                                                </script>
                                            </td>
                                            ...
                                            <td><button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <form method="post"><button class="dropdown-item" name="deleteuser" value="<?php echo $user; ?>">Delete</button>
                                                        ...
                                                        <button class="dropdown-item" name="edituser" value="<?php echo $user; ?>">Edit</button>
                                                </div>
                                            </td>
                                        </tr>
                                        </form>
