    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <form method="post">
                ...
                <button name="dellogs" onclick="return confirm('Are you sure you want to delete all logs?')" class="dt-button buttons-print btn btn-primary mr-1"><i class="fas fa-trash-alt fa-sm text-white-50"></i> Delete All Logs</button>
            </form>
                            ...
                            <tbody>
                                ...
                                ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <script>
                                                        document.write(convertTimestamp(<?php echo $row["logdate"]; ?>));
                                                    </script>
                                                </td>
