...
<head>
	...
	<link href="https://cdn.keyauth.uk/dashboard/assets/libs/dropzone/dist/min/dropzone.min.css" rel="stylesheet">
	<link href="https://cdn.keyauth.uk/dashboard/assets/libs/summernote/dist/summernote-bs4.css" rel="stylesheet">
...
<div id="create-files" class="modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
					...
					if(isset($_POST['addfile']))
                    {
                        ...
                        mysqli_query($link, "INSERT INTO `files` (name, id, url, size, uploaddate, app, authed) VALUES ('$fn', '$id', '$url', '$fs', '".time()."', '".$_SESSION['app']."', '$authed')");
